...
<head>
    ...
    <title>Cálculo — Matemáticas Activa</title>
    <meta name="description" content="Cálculo en Matemáticas Activa: funciones, análisis y graficadora interactiva.">
...
<body data-materia="calculo" data-nombre="Cálculo" data-emoji="∫">
    ...
    <noscript>
        <div style="max-width:640px;margin:40px auto;padding:20px;border:1px solid #e2e8f0;border-radius:12px;font-family:sans-serif;text-align:center">
            <h1>Cálculo — Matemáticas Activa</h1>
