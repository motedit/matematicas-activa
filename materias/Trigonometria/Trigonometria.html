...
<head>
    ...
    <title>Trigonometría — Matemáticas Activa</title>
    <meta name="description" content="Trigonometría en Matemáticas Activa: seno, coseno, tangente y aplicaciones.">
...
<body data-materia="trigonometria" data-nombre="Trigonometría" data-emoji="θ">
    ...
    <noscript>
        <div style="max-width:640px;margin:40px auto;padding:20px;border:1px solid #e2e8f0;border-radius:12px;font-family:sans-serif;text-align:center">
            <h1>Trigonometría — Matemáticas Activa</h1>
