...
<head>
    ...
    <title>Juegos Matemáticos — Matemáticas Activa</title>
    <meta name="description" content="Juegos matemáticos para aprender jugando: lógica, números y diversión.">
...
<body data-materia="juegos" data-nombre="Juegos Matemáticos" data-emoji="🎮">
    ...
    <noscript>
        <div style="max-width:640px;margin:40px auto;padding:20px;border:1px solid #e2e8f0;border-radius:12px;font-family:sans-serif;text-align:center">
            <h1>Juegos Matemáticos — Matemáticas Activa</h1>
