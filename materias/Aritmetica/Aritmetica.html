...
<head>
    ...
    <title>Aritmética — Matemáticas Activa</title>
    <meta name="description" content="Aritmética en Matemáticas Activa: fundamentos esenciales, operaciones y ejercicios.">
...
<body data-materia="aritmetica" data-nombre="Aritmética" data-emoji="🔢">
    ...
    <noscript>
        <div style="max-width:640px;margin:40px auto;padding:20px;border:1px solid #e2e8f0;border-radius:12px;font-family:sans-serif;text-align:center">
            <h1>Aritmética — Matemáticas Activa</h1>
